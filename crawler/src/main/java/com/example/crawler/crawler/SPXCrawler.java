...
public class SPXCrawler extends AMyCrawler {

	private static final String URL = "https://vn.investing.com/indices/us-spx-500";
	KafkaPublisher publisher = new KafkaPublisher("broker:29092");
	String topic = "spx-data";

	public SPXCrawler(AMyDriverContext myDriver) {
		super(myDriver);
	}
